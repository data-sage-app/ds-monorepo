...
WITH latest_variants AS (
    SELECT 
        ...
        jsonb_array_elements(shopify_data->'variants') ->> 'grams' AS grams,
        jsonb_array_elements(shopify_data->'variants') ->> 'price' AS price,
        jsonb_array_elements(shopify_data->'variants') ->> 'title' AS title,
        jsonb_array_elements(shopify_data->'variants') ->> 'weight' AS weight,
